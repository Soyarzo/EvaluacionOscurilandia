...
public class Menu {
	...
	/**
	 * El método escribir() es una función orientada a escribir mensaje. El mensaje es el mismo pero la funcion utilizada dependerá 
	 * del valor booleano que se entregue. Si el valor del booleano es verdadero se utiliza la funcion System.out.println() la cual
	 * agrega un salto de linea posterior a la impresion del mensaje, mientras que de ser falso la función ulizada en System.out.print()
	 * la que no contempla un salto de linea, es decir, se sigue ejecutando el código hacia a la derecha de la misma linea del mensaje.
	 * @param mensaje
	 * @param salto
	 */
